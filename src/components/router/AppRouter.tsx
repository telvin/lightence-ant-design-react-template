...
import VisiriDemoPage from '@app/pages/DashboardPages/VisiriDemoPage';
...
export const VISIRI_DEMO_PATH = '/visiri-demo';

const MedicalDashboard = withLoading(MedicalDashboardPage);
const NftDashboard = withLoading(NftDashboardPage);
const VisiriDemo = withLoading(VisiriDemoPage);
    ...
    <BrowserRouter>
      <Routes>
        <Route path={NFT_DASHBOARD_PATH} element={protectedLayout}>
          ...
          <Route path={VISIRI_DEMO_PATH} element={<VisiriDemo />} />
          <Route path="apps">
